...
function displayGameOver() {
  context.fillStyle = "#2C3E50"; // Red color
  ...
  const gameOverTextX = (board.width - context.measureText(gameOverText).width) / 2;
  const gameOverTextY = board.height / 3;

  const scoreTextX = gameOverTextX + 35 ;
  const scoreTextY = board.height / 2;
